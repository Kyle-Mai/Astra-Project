...
public class planetClass extends planetCore implements Serializable {
    ...
    public planetClass(starClass parentStar, String planetName, int planetType, int planetNumber, long distanceFromStar, int planetRadius, boolean isInHabitableZone, boolean isHabited, boolean isPlanetHabitable, boolean isTidallyLocked, int numOfMoons, boolean homePlanet) {
