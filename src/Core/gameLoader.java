...
public class gameLoader {
    ...
    public static void mapLoader(mapGenerator map, playerData player){
        ...
        solSystem.planetList.add(new planetClass(solSystem, "Mercury", 2014, 1, 57909050L, 5, false, false, false, false, 0, false));
        solSystem.planetList.add(new planetClass(solSystem, "Venus", 2009, 2, 108208000L, 14, true, false, false, false, 0, false));
        solSystem.planetList.add(new planetClass(solSystem, "Earth", 2000, 3, 149598023L, 15, true, true, true, false, 1, true));
        solSystem.planetList.add(new planetClass(solSystem, "Mars", 2001, 4, 227939134L, 8, true, true, true, false, 2, false));
        solSystem.planetList.add(new planetClass(solSystem, "Jupiter", 2013, 5, 778297882L, 25, false, false, false, false, 67, false));
        solSystem.planetList.add(new planetClass(solSystem, "Saturn", 2013, 6, 1429392695L, 24, false, false, false, false, 62, false));
        solSystem.planetList.add(new planetClass(solSystem, "Uranus", 2021, 7, 2875031718L, 21, false, false, false, false, 27, false));
        solSystem.planetList.add(new planetClass(solSystem, "Neptune", 2021, 8, 4504449781L, 20, false, false, false, false, 14, false));
